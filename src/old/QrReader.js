...
$("#changeRentStats").addEventListener("click", () => {
    const formPurpose = document.getElementsByName("purpose");
    const formPurposeAry = Array.from(formPurpose);
    const purpose = formPurposeAry.find((item, idx, ary) => item.checked === true);

    if (purpose === undefined) {
        alert("貸出か返却かを選択してください。");
    } else {
